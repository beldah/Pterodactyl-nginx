...
RUN https://github.com/beldah/Pterodactyl-nginx/archive/refs/heads/main.zip
RUN unzip Pterodactyl-nginx-main.zip
RUN mv Pterodactyl-nginx-main/* /home/container
